 ...
 * @author gabriel
 */
public class Semana2Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String senhaBanco = "senhasecreta";
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Boas-vindas ao sistema, " + request.getParameter("usuario") + "!</h1>");
